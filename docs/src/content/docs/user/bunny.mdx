---
title: "2D Canvas and Worker Messaging"
description: "A case study in profiling 2D canvas and worker messaging."
---
...
![A picture of a 3d bunny rabbit model rendered using small squares.](/images/user/user/bunny-analysis/bunny.png)
...
![A view of the threads list with "Content", "DOM Worker", and "Compositor". It shows the interchange of time spent communicating back and forth.](/images/user/user/bunny-analysis/threads-list.png)
...
![A range selection of the above thread list showing 66ms.](/images/user/user/bunny-analysis/threads-list-measure.png)
...
![A screenshot of the context menu on the flame graph for focus subtree.](/images/user/user/bunny-analysis/focus-subtree.png)
...
![Screenshot of the flame graph of the content process.](/images/user/user/bunny-analysis/flame-graph-content.png)
...
![Screenshot of the flame graph of the worker process.](/images/user/user/bunny-analysis/flame-graph-worker.png)
...
![Screenshot of the thread list and the faster times..](/images/user/user/bunny-analysis/fillstyle-thread-list-measure.png)
...
![Screenshot of the flame graph of the content process after applying the fix.](/images/user/user/bunny-analysis/flame-graph-set-fillstyle.png)
...
![A screenshot of the thread list with the new code changes](/images/user/user/bunny-analysis/clone-thread-list.png)
...
![A screenshot of the flame graph of the content process' main thread](/images/user/user/bunny-analysis/clone-flame-content.png)
...
![A screenshot of the flame graph of the worker](/images/user/user/bunny-analysis/clone-flame-worker.png)
