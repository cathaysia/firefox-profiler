---
title: "UI Tour: The Panels"
description: "A tour of the analysis panels in the Firefox Profiler UI."
---
...
![A screenshot highlighting the panels on the lower half of the UI.](/images/user/ui-tour-panels.png)
...
![A screenshot of the call tree including the sidebar](/images/user/ui-tour-panels-call-tree.png)
...
![A screenshot of the flame graph](/images/user/ui-tour-panels-flame-graph.png)
...
![A screenshot of the stack chart](/images/user/ui-tour-panels-stack-chart.png)
...
![A screenshot of the marker chart](/images/user/ui-tour-panels-marker-chart.png)
...
![A screenshot of the network chart](/images/user/ui-tour-panels-network-chart.png)
