...
description: "Profiling Firefox remotely over USB or network."
---
...
![A screenshot of about:debugging after connecting](/images/user/about-debugging-remote.png)
![A screenshot of about:debugging after clicking Profile Performance](/images/user/about-debugging-remote-profiling-panel.png)
