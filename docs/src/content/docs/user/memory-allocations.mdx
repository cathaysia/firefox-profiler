...
description: "Understanding memory allocation data in the Firefox Profiler."
---
...
![A screenshot showing the memory track in the timeline.](/images/user/allocation-track.png)
...
![A screenshot of the call tree showing native allocations.](/images/user/allocation-calltree-2019-12-11.png)

![A screenshot of the flame graph showing native allocations.](/images/user/allocation-flame-graph-2019-12-11.png)
...
![A screenshot showing the Profiler Icon and the Profiler Popup.](/images/user/popup.png)

![A screenshot of the UI to turn on native allocations.](/images/user/allocation-feature.png)
...
![A screenshot of the call tree showing JS.](/images/user/allocation-js.png)
