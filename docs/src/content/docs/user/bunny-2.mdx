...
description: "A case study in harnessing parallelism."
---
...
![A view of the content and worker stacks. The content thread does work and is blocked as the worker thread does work, making things effectively synchronous.](/images/user/user/bunny-analysis/threads-sync.png)
...
![A view of the content and worker stacks. The content thread and worker thread do work in parallel, and are not blocked by each other.](/images/user/user/bunny-analysis/threads-parallel.png)
...
![A view of the content and worker stacks. The content thread and worker thread do work one after the other. There is a large gap between frames.](/images/user/user/bunny-analysis/threads-work-sync.png)
...
![A view of the content and worker stacks. The content thread and worker thread do work in parallel, and are not blocked by each other.](/images/user/user/bunny-analysis/threads-work-parallel.png)
