---
title: "Profiler Fundamentals"
description: "Core concepts behind the Firefox Profiler."
---
...
![A picture of the UI in about:profiling to adjust the sampling interval.](/images/user/interval-2020-05.png)
