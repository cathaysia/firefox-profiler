---
title: "IPC Messages"
description: "Profiling IPC messages in Firefox."
---
...
![A screenshot of the popup UI for an IPC message.](/images/user/ipc-messages-popup.png)
...
![A screenshot of the UI to turn on IPC messages.](/images/user/ipc-messages-feature.png)
...
![A screenshot of the UI to profile the IO threads](/images/user/ipc-messages-io-threads.png)
