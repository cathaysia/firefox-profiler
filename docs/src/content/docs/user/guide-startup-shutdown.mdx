---
title: "Profiling Firefox Startup & Shutdown"
description: "How to profile Firefox startup and shutdown."
---
...
First, you'll need to use [the general information about profiling on Android](/user/guide-remote-profiling).
