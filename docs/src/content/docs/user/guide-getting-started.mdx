...
description: "An overview of how to capture a profile with Firefox Profiler."
---
...
![A screenshot of the profiler website homepage highlighting the button](/images/user/getting-started-enable-popup.png)
...
![A screenshot of the profiler popup](/images/user/getting-started-popup.png)
...
![A screenshot of the Devtools performance panel](/images/user/getting-started-devtools-panel.png)
...
<video controls src="/videos/getting-started-use-popup.webm" style="width:100%">Your browser does not support the video tag.</video>
...
<video controls src="/videos/getting-started-use-icon.webm" style="width:100%">Your browser does not support the video tag.</video>
...
![A screenshot highlighting the toolbar's upload profile button.](/images/user/getting-started-upload.png)
...
<video controls src="/videos/getting-started-upload-permalink.webm" style="width:100%">Your browser does not support the video tag.</video>
...
![A screenshot showing the delete button in the profile info panel](/images/user/getting-started-delete-profile.png)

You can also go to the [Uploaded Recordings page](/uploaded-recordings/) to list
...
![A screenshot showing the list of uploaded profiles](/images/user/getting-started-list-uploaded-profiles.png)

## Name a profile

![A screenshot highlighting the location for the name of a profile](/images/user/getting-started-naming-profiles.png)
