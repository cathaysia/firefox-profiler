---
title: "Filtering Call Trees"
description: "How to filter and transform call trees."
---
...
![A screenshot of the search box](/images/user/search-2022-06-16.png)
...
![The image demonstrates the search filter. On the left is a call tree that has all stacks, and on the right is the filtered call tree that does not have any stacks that do not have the function C.](/images/user/filter-search.svg)
...
![A screenshot of the implementation filter dropdown.](/images/user/implementation-2022-06-16.png)
...
![This graphic shows going from a combination of mixed native stacks and JavaScript stacks to only JavaScript stacks. The shape JavaScript stacks are interleaved on the mixed graph, but form a single non-branching tree in the JavaScript only version.](/images/user/implementation-filter.svg)
...
![A screenshot of the "Invert call stacks" checkbox.](/images/user/invert-2022-06-16.png)
...
![An image showing samples on the left and the call tree on the right. This is before the invert operation.](/images/user/invert-before.svg)
...
![An image showing samples on the left and the call tree on the right. This is after the invert operation.](/images/user/invert-after.svg)
...
![A screenshot of the transforms in the contextmenu.](/images/user/transforms-2022-06-16.png)
