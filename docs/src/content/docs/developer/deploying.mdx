---
title: "Deploying"
description: "How to deploy the Firefox Profiler to production."
---
...
![The link to the preview deployment is in the sections where checks are](/images/developer/netlify-link.png)
